...
public class CurrencyExchangeController {
    ...
    @GetMapping(path = {"/api/timeseriesweekly/{from}/and/{to}"})
    ...
    @GetMapping(path = {"/api/timeseriesdaily/{from}/and/{to}"})
    ...
    public List<CurrencyChangeToList> getListOfPeroidTimeCurrencyExchange(String timeExchangeUrl, String peroid) throws JsonProcessingException {
